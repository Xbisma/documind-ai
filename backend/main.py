...
from backend.services.doc_store import find_doc_source_path, list_docs_for_session
...
def download_doc(session_id: str, doc_id: str):
    ...
    """
    info = find_doc_source_path(session_id=session_id, doc_id=doc_id)
    if not info:
        raise HTTPException(status_code=404, detail="Document not found for this session_id/doc_id.")
